...
export const VALUE_SYNONYMS: Record<string, string[]> = {
  ...
  impact: ["impact", "meaningful impact", "השפעה"],
  mission: [
    "mission",
    "mission-driven work",
    "mission driven work",
  ...
  craft: ["craft", "craft excellence", "skills & craft", "מקצועיות", "אומנות"],
  team_quality: [
    "team quality",
    "great team",
    "great team & culture",
  ...
  skills: ["skills", "skills & craft", "כישורים"],
  ...
  motivation: ["motivation", "מוטיבציה"],
