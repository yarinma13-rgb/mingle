...
### החלטת מוצר שדורשת את יערין — לא רק תיקון
צד Talent ב-Dark theme, צד Company ב-Light theme — לא עקבי בין הצדדים. שתי אופציות: (א) לאחד ברירת מחדל אחת עם מתג Dark/Light לשניהם, או (ב) לשמר את ההבדל בכוונה עם שפה עיצובית משותפת. **לא להחליט לבד — לחכות לבחירת יערין.**
