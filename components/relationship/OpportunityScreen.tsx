          ...
          <div className="flex flex-col gap-4 rounded-2xl border border-mingle-border bg-mingle-surface p-6">
            <div>
              ...
              <input
                ...
                maxLength={120}
                className="w-full rounded-xl border border-mingle-border bg-mingle-bg px-4 py-2.5 text-sm text-mingle-text placeholder:text-mingle-text-secondary focus:border-mingle-blue focus:outline-none"
              />
            </div>
            <div>
              <label className="mb-1.5 block text-xs font-medium text-mingle-text-secondary">
              ...
              <textarea
                ...
                rows={4}
                maxLength={1200}
                className="w-full resize-none rounded-xl border border-mingle-border bg-mingle-bg p-4 text-sm text-mingle-text placeholder:text-mingle-text-secondary focus:border-mingle-blue focus:outline-none"
              />
            </div>
